...
namespace Bakery.Zayiler
{
    public partial class KruvasanlarZay_ : Form
    {
        ...
        {
            ba.BaglantiAc();
            lm.KruvasanZayileriListele(zayiler_table);
        }

        private void btnEkle_Click(object sender, EventArgs e)
        {
            string kruvasan = cmbkruvasan.Text;
            DateTime gün = dtpgün.Value;
            string adet = txtAdet.Text;
            string fiyat = txtFiyat.Text;
            im.KruvasanlarZayiEkle(kruvasan, gün, adet, fiyat);
